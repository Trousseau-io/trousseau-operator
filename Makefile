...
# trousseau.io/trousseau-operator-bundle:$VERSION and trousseau.io/trousseau-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/trousseau-io/trousseau-operator
